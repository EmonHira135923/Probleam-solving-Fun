...
// void insert_it_pos(Node* Head,int val,int pos)
// {
//     Node* newnode = new Node(val);
//     Node* tmp = Head;
//     for(int i=1;i<=pos-1;i++)
...
int main()
{
    ...
    int pos,v;
    cin >> pos >> v;
    if(pos>size_cnt(Head)) cout << "Invalid Index" << endl;
    else if(pos==0) insert_it_Head(Head,v);
    else insert_it_pos(Head,v,pos);
    print_it(Head);
    ...
    // else insert_it_pos(Head,val,pos);
    // print_it(Head);
    // cout << size_cnt(Head) << endl;
